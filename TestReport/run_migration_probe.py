...
保留迁移的真实价值，改在 PG 上验证：
  ...
  4. 002 数据规整：只 upgrade 到 '001'（建表）→ 插 planning/archived/in_progress 三态任务
     ...
     （003 run_queue 部分唯一索引 / 004 task_runs.kill_requested_at 均与数据规整无关，本子检仍只测到 002。）
